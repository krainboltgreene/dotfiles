...
# FIXME: Ubuntu 20 alias ls="exa --tree --level=1 --long --header --classify --all --git --color-scale --sort=type --time-style=long-iso"
# FIXME: Ubuntu 20 alias la="exa --tree --level=2 --long --header --classify --all --git --color-scale --ignore-glob='node_modules' --sort=type --time-style=long-iso"
# FIXME: Ubuntu 20 alias tree="exa --tree --long --header --classify --all --git --color-scale --sort=type --binary --time-style=long-iso"

# This handles some weirdness terminals get into with printing characters
stty sane
